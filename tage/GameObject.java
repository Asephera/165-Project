...
public class GameObject
{
	...
	// + you should abstract 'types' to a "Part extends GameObject" class
	/** assigns a string object type for keying with object utility */
	public void setType(String ty) { type = ty; }

	/** returns object type in form of string */
	...
	public void move(float spd) { this.setLocalLocation(this.getWorldLocation().add(this.getWorldForwardVector().mul(spd))); }

	/** adjusts object to rotate about local up axis */
	public void yaw(float angle) { this.setLocalRotation(localRotation.rotateY((float)java.lang.Math.toRadians(angle))); }

	/** adjusts object to rotate about global up axis */
	public void globalYaw(float angle) { this.setLocalRotation(localRotation.rotateLocalY((float)java.lang.Math.toRadians(angle))); }

	/** adjusts the object to rotate about local right axis */
	public void pitch(float angle) { this.setLocalRotation(localRotation.rotateX((float)java.lang.Math.toRadians(angle))); }
