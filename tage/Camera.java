...
public class Camera
{
	...
	/** moves object by forward vector times speed */
	public void move(float spd) { this.setLocation(this.getLocation().add(this.getN().mul(spd))); }

	/** yaws object across global y vector and angle */
	public void yaw(float angle) 
	{ 	this.setU(this.getU().rotateAxis(0.01f*angle, this.getV().x(), this.getV().y(), this.getV().z()));
		this.setN(this.getN().rotateAxis(0.01f*angle, this.getV().x(), this.getV().y(), this.getV().z())); }
